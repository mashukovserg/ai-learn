...
- **Room pages implemented:** 49 in `ROOMS_METADATA`, all 49 fully wired (`research-ai-era` wired up 2026-08-18; `ai-literature-review` absorbed the orphaned SLR-tooling chapters the same day)

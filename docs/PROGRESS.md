...
- **Room pages implemented:** 45 in `ROOMS_METADATA`, all 45 fully wired (`git-safety-net` and `github-actions-ci` landed 2026-07-29)
...
| Date | Milestone |
|------|-----------|
| 2026-08-02 | New room  (Intermediate, ideas-history path): Schuster & Kilov 2025 — the dual challenge (epistemic justification + political legitimacy) against crowdsourcing/RLHF/constitutional AI on morally contested decisions. 5 bilingual chapters + 12 tasks;  glossary term. Room count 46→47; gate green (2178). |

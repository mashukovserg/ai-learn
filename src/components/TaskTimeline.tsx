          ...
          >
            {renderedLabels.map(label => (
              <Reorder.Item
                key={label}
                value={label}
                className="relative flex items-center gap-3 p-2 rounded-md border border-border-subtle bg-base text-sm text-neutral-300 hover:border-neutral-700 cursor-grab active:cursor-grabbing"
              >

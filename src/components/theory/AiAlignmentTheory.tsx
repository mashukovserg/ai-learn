      ...
      <div className="bg-card-dark border border-border-card rounded-xl p-8 mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-accent-500/10 p-6 rounded-xl border border-accent-500/20">
             ...
             <p className=" text-neutral-300 leading-relaxed">
               {lang === 'ru'
                 ? 'Alignment — не патч безопасности для чат-бота, а попытка построить мост между биологическим интеллектом и цифровым разумом и гарантировать, что этот мост не рухнет под тяжестью новых способностей ИИ. Выравнивание — это самая важная инженерная дисциплина XXI века.'

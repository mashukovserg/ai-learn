      ...
      <section className="bg-card-dark border border-border-card rounded-xl p-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-neutral-300 leading-relaxed">
            {lang === 'ru' ? (
              <>
                Решение — <strong>Multi-Agent Systems (MAS)</strong>. Мы разделяем ответственность между специализированными агентами. Один планирует, другой пишет код, третий проверяет. Это не «несколько чатов», а архитектурный паттерн, где каждый участник имеет узкий контекст, четкие инструменты и измеримую зону ответственности.
              </>
            ) : (
              <>

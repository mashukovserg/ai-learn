    ...
    <>
      ...
      <div className="bg-card-dark border border-border-card rounded-xl p-8 mb-8">
        ...
        <div className="space-y-6">
          <p className="text-neutral-300 leading-relaxed">
            {lang === 'ru'
              ? 'Когда пользователь задает вопрос, начинается "магия" дополнения запроса. Процесс RAG — не обычный поиск, а сложная хореография данных, которая происходит за кулисами чата.'

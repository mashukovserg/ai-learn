...
│   │   ├── metadata.ts          # ROOMS_METADATA (46 rooms)
...
- **46 rooms** in `ROOMS_METADATA`, all 45 fully wired (theory + tasks) — `git-safety-net` (AC-105) and `github-actions-ci` (AC-206) landed 2026-07-29.
